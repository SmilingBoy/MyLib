...
import com.ishuangniu.customeview.apppay.view.MDProgressBar;
import com.ishuangniu.customeview.apppay.view.PasswordKeyboard;
import com.ishuangniu.customeview.apppay.view.PasswordView;
...
public class PasswordKeypad extends DialogFragment implements View.OnClickListener, PasswordKeyboard.OnPasswordInputListener,
    ...
    public void onAttach(Activity context) {
        ...
        if (context instanceof OnCallBack) {
            mOnCallBack = (OnCallBack) context;
        }
    }
    ...
    public void onClick(View v) {
        if (R.id.cancel_dialog == v.getId()) {
            if (mOnCallBack != null) {
                mOnCallBack.onCancel();
            }
            dismiss();
        } else if (R.id.forget_password == v.getId()) {
            if (mOnCallBack != null) {
                mOnCallBack.onForgetPassword();
            }
        }
    }
    ...
    public void onPasswordCorrectly() {
        if (mOnCallBack != null) {
            mOnCallBack.onPasswordCorrectly();
        }
    }
    ...
    private void startLoading(CharSequence password) {
        ...
        if (mOnCallBack != null) {
            mOnCallBack.onInputCompleted(password, this);
        }
    }
