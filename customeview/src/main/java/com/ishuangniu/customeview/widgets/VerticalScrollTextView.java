 ...
 * @author Smile
 */
public class VerticalScrollTextView<T> extends RelativeLayout {
    /**
     * 默认轮播时间间隔：3s
     */
    ...
    private void init(Context context) {
        ...
        getRootView().setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != onItemClickListener && !mDataSource.isEmpty()) {
                    onItemClickListener.onClick(mDataSource.get(mCurrentItemIndex), mCurrentItemIndex);
                }
            }
        });
    }
    ...
    private void resetData() {
        ...
        String normal = mDataSource.get(0).toString();
    ...
    private void autoSlider() {
        ...
        String normal = mDataSource.get(mCurrentItemIndex).toString();
        ...
        String next = mDataSource.get(mCurrentItemIndex).toString();
