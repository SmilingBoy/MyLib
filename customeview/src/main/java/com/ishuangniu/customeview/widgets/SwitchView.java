...
public class SwitchView extends View {
    ...
    public SwitchView(Context context, AttributeSet attrs) {
        ...
        colorPrimary = a.getColor(R.styleable.SwitchView_zq_primaryColor, DEFAULT_COLOR_PRIMARY);
        colorPrimaryDark = a.getColor(R.styleable.SwitchView_zq_primaryColorDark, DEFAULT_COLOR_PRIMARY_DARK);
        hasShadow = a.getBoolean(R.styleable.SwitchView_zq_hasShadow, true);
        isOpened = a.getBoolean(R.styleable.SwitchView_zq_isOpened, false);
